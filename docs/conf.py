...
project = 'aiowintest'
copyright = '2018, Hans Insulander <hans@codium.se>'
author = 'Hans SM0UTY'
...
htmlhelp_basename = 'aiowintestdoc'
...
latex_documents = [
    (master_doc, 'aiowintest.tex', 'aiowintest Documentation',
     'Hans SM0UTY', 'manual'),
]
...
man_pages = [
    (master_doc, 'aiowintest', 'aiowintest Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'aiowintest', 'aiowintest Documentation',
     author, 'aiowintest', 'One line description of project.',
     'Miscellaneous'),
]
